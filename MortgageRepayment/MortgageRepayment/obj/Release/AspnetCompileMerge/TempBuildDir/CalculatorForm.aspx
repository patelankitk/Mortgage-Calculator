<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalculatorForm.aspx.cs" Inherits="MortgageRepayment.WebForm1" %>
    ...
    <form id="form1" runat="server" width="80%" class="form1">
        <div class="container" style="width: 90%" >
          ...
          <asp:Label ID="LabelSavedInterest" runat="server" ForeColor="Black">£101122.02</asp:Label>
            ...
            <div>
                <p>
                    N<b>ew Mortgage plan with additional
            ...
            <div>
                ...
                <table style="border: thin solid #000000; width: 100%; background-color: #FFFFFF;" class="auto-style4">
                    <tr>
                        <td class="auto-style28" style="border: thin solid #FFFFFF"><span class="auto-style46">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Mortage amount at start.</td>
                        <td style="border: thin solid #FFFFFF" class="auto-style29">
                            <asp:Label ID="LabelAmountAtStart" runat="server" Text="£200000.00"></asp:Label></span></td>
                    </tr>
